...
//
// libtabnashoover is the hoover format parser as a C shared library, one of
...
// newParser builds one engine with the hoover grammar installed
...
// parseWith answers whether src is in the hoover language — and,
